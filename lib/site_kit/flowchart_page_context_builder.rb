...
module SiteKit
  class FlowchartPageContextBuilder
    def initialize(eureka_browsers:, eureka_topics:, flowcharts:, flowchart_record:, flowchart_summaries:, page_link_resolver:)
    ...
    attr_reader :eureka_browsers, :eureka_topics, :flowcharts, :flowchart_record, :flowchart_summaries, :page_link_resolver
